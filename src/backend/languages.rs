...
#[derive(Debug, Hash, Eq, PartialEq, Copy, Clone, PartialOrd, Ord, TryFromPrimitive)]
#[repr(u8)]
pub enum Languages {
    Binary,
    PlainText,
...
const FILENAMES_VERILOG: [&str; 2] = [
    "*.v",
    "*.veo",
];
const FILENAMES_C: [&str; 3] = [
    "*.c",
    "*.h",
    "*.h.in",
];
const FILENAMES_CSS: [&str; 1] = [
    "*.css",
];
...
const FILENAMES_HASKELL: [&str; 3] = [
    "*.hs",
    "*.hs-boot",
    "*.hsc",
];
const FILENAMES_SCALA: [&str; 4] = [
    "*.scala",
    "*.kojo",
    "*.sbt",
    "*.sc",
...
const FILENAMES_JULIA: [&str; 1] = [
    "*.jl",
];
const FILENAMES_CSHARP: [&str; 4] = [
    "*.cs",
    "*.cake",
    "*.cs.pp",
    "*.csx",
];
const FILENAMES_REGEX: [&str; 2] = [
    "*.regexp",
    "*.regex",
];
const FILENAMES_GO: [&str; 1] = [
    "*.go",
];
...
const FILENAMES_TYPESCRIPT: [&str; 3] = [
    "*.ts",
    "*.cts",
    "*.mts",
];
const FILENAMES_JAVA: [&str; 3] = [
    "*.java",
    "*.jav",
    "*.jsh",
];
...
const FILENAMES_RUST: [&str; 2] = [
    "*.rs",
    "*.rs.in",
];
const FILENAMES_ERBEJS: [&str; 5] = [
    "*.ejs",
    "*.ect",
    "*.ejs.t",
    "*.jst",
